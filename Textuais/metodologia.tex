...
Quanto à multicolinearidade, adotou-se a mitigação estrutural: remoção de colunas constantes/raras e monitoramento da estabilidade dos sinais e erros-padrão ao longo das estimativas. Medidas formais (p.\,ex., VIF) não foram computadas nesta versão. Os erros-padrão reportados são os do estimador.
