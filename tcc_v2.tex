...
\orientador{Prof.\textsuperscript{a} Dra.\ Marianne Zwilling {}Stampe}%
...
\include{Textuais_v2/introducao}
\include{Textuais_v2/revisao_literatura}
\include{Textuais_v2/metodologia}
\include{Textuais_v2/resultados}
\include{Textuais_v2/conclusao}
...
\include{PosTextuais_v2/Glossario}			% Elemento Opcional
\include{PosTextuais_v2/Apendices}			% Elemento Opcional
\include{PosTextuais_v2/Anexos}				% Elemento Opcional
