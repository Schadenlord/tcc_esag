...
\input{Textuais/analise_v2/outputs/tables/tex/tab_descritiva.tex}
...
\input{Textuais/analise_v2/outputs/tables/tex/tab_sintese_v2.tex}
...
\input{Textuais/analise_v2/outputs/tables/tex/tab_brant.tex}
...
\input{Textuais/analise_v2/outputs/tables/tex/tab_gof.tex}

% ----------------------------------------------------------
\chapter{Bootstrap BC\texorpdfstring{$_0$}{0}: Todos os 53 Itens}
% ----------------------------------------------------------
\label{apendice:tab_bootstrap_v2}

Intervalos de confiança de 95\% pelo método bootstrap BC$_0$ (bias-corrected percentile), $B = 999$ reamostras, semente 42, para os 53 itens analisados por modelos logit ordenado (excluídas as 5 DVs com Hessiana singular, estimadas via Firth-Ridge, para as quais o bootstrap requer adaptação não implementada). Os quatro itens pré-especificados de interesse especial são indicados em destaque na tabela.

\input{Textuais/analise_v2/outputs/tables/tex/tab_bootstrap_v2.tex}
...
\input{Textuais/analise_v2/outputs/tables/tex/tab_permutation.tex}
...
\input{Textuais/analise_v2/outputs/tables/tex/tab_firth.tex}
...
\input{Textuais/analise_v2/outputs/tables/tex/tab_power.tex}

\begin{figure}[htbp]
\centering
\caption{Curva de poder: probabilidade de rejeitar $H_0$ em função da \textit{odds ratio} real.}
\includegraphics[width=0.80\textwidth]{Textuais/analise_v2/outputs/figures/forestplots/power_curve.png}
...
O pipeline de análise v2 está em \texttt{Textuais/analise\_v2/}, com ponto de entrada único em \texttt{run\_all.py}. Para reproduzir integralmente todas as tabelas e figuras:
