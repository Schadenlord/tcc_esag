...
\begin{enumerate}[label=\alph*)]
  ...
  \item \textbf{H1 — O público geral brasileiro exibe padrões sistemáticos de julgamento econômico que divergem das posições predominantes entre economistas com pós-graduação.}
  O estudo testa se essa divergência é detectável e se varia com o posicionamento ideológico do respondente; \textit{não} testa os mecanismos psicológicos que a produzem (o design cross-sectional não permite identificar processos cognitivos internos, apenas diferenças observáveis entre grupos). H1 é refutada se não emergir padrão sistemático de diferença condicional entre grupos em múltiplos itens \cite{The_Myth_of_the_Rational_Voter,blendon1997}.
