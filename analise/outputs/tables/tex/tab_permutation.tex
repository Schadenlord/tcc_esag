...
\noindent\textit{\textbf{Notas:}}\ MWU = Mann-Whitney U (two-sided, dominância estocástica); KS = Kolmogorov-Smirnov; Permut.\ = diferença de medianas ($B=5000$). Testes \textit{marginais}: não controlam covariates. BH sobre família de 53 testes.
\end{minipage}
\endgroup
