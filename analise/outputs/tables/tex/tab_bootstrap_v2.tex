...
\textit{\textbf{Notas:}}\ Reamostras sem variação em \texttt{econ} descartadas. $p_\text{boot} = 2\min(f_{<0},f_{>0})$ (teste de sinal). BC$_0$ = bootstrap com correção de viés pela mediana (Efron \& Tibshirani 1993, \S12.4). DVs singulares usam Firth-Ridge nas reamostras. 53 DVs reportados.
\end{minipage}
\endgroup
