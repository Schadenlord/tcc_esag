...
\midrule
\endfirsthead
\multicolumn{6}{l}{\footnotesize \textit{(continuação)}}\\\toprule
\textbf{DV} & $K$ & $\chi^2$ & df & $p$ & PO ok? \\
\midrule
\endhead
\midrule
...
\noindent\textit{\textbf{Notas:}}\ H$_0$: coeficientes idênticos entre thresholds (suposição de chances proporcionais). Deseja-se $p > 0{,}05$. $K$ = número de categorias da DV. 53 DVs testados.
\end{minipage}
\endgroup
