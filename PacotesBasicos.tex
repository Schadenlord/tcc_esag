...
\newcommand{\notafig}{\footnotesize\emph{\newline Nota: Valores previstos pelos modelos logit (ordenados ou binários) para as três categorias de respondentes (público geral sem formação em Economia, público “esclarecido” com formação atribuída e economistas), com intervalos de confiança de 95\%. O público “esclarecido” representa um cenário contrafactual no qual os respondentes leigos são simulados como se tivessem formação em Economia, mantendo-se constantes as demais variáveis.}}%
